...
public class BigComplex {
    ...
    public BigComplex divide(BigComplex c) {
        return new BigComplex(
            ((this.real.multiply(c.real)).add(this.imaginary.multiply(c.imaginary)).divide((c.real.pow(2)).add(c.imaginary.pow(2)))),
            ((((this.imaginary).multiply(c.real)).subtract((this.real).multiply(c.imaginary))).divide((c.real.pow(2)).add(c.imaginary)))
        );
    }
